...
DROP FUNCTION IF EXISTS public.calculate_expected_collection_date(DATE, TEXT);
DROP FUNCTION IF EXISTS public.calculate_units_from_size(TEXT);
DROP FUNCTION IF EXISTS public.orders_auto_calculate();
